...
export const AiBrainIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2a4 4 0 0 0-4 4v2.2c0 .4-.2.9-.5 1.2-1.5 1.7-2 4.2-1.1 6.4.8 2 2.5 3.5 4.6 4.2.5.2 1 .2 1.5 0 2.1-.7 3.8-2.2 4.6-4.2.9-2.2.4-4.7-1.1-6.4-.3-.3-.5-.8-.5-1.2V6a4 4 0 0 0-4-4z" />
